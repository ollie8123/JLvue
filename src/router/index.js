			...
			children: [
				{
					path: 'userCoupon',
					name: 'userCoupon',
					component: () => import('../views/user/userCoupon/userCoupon.vue'),
				},
				{
					path: 'orderList',
					name: 'orderList',
							...
							children: [
								{
									...
									component: () =>
										import(
											'../views/user/account/payment/CreateCreditcard.vue'
										),
								},
							],
						},
		...
		//seller頁面
		{
			...
			children: [
				...
				},
				{
					path: 'product',
					name: '商品管理',
					component: () => import('../views/seller/product/productMain.vue'),
					redirect: {
						name: '我的商品',
					},
					children: [
						{
							path: 'myProducts',
							name: '我的商品',
							component: () => import('../views/seller/product/myProducts.vue'),
						},
						{
							path: 'addProducts',
							name: '新增商品',
							component: () =>
								import('../views/seller/product/addProducts.vue'),
						},
					],
				},
				{
					...
					children: [
						...
						},
						{
							...
							name: 'insert',
							component: () =>
								import('../views/seller/coupon/couponInsert.vue'),
						},
						{
							path: 'edit/:id',
							name: 'edit',
