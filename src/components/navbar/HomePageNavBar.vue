<template>
  ...
  <nav id="mainNav" class="navbar navbar-light navbar-expand-lg bg-black text-uppercase ">
    <div class="d-flex w-100 justify-content-between ">
      <!-- 左 - LOGO開始 -->
      <div class="logoDiv "><a class="navbar-brand " href="#page-top">
          <RouterLink to="/"><img src="/image/logo/navbarlogo.png" alt="" class="logo"></RouterLink>
        </a>
      </div>
      <!-- 左 - LOGO結束 -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-3 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              <span class="accountArea d-flex">
                ...
                <span class="dropdown-toggle-wrapper" data-bs-toggle="dropdown">
                  <a class="nav-link dropdown-toggle text-dark accountText" href="#" id="navbarDropdown" role="button"
                    aria-expanded="false">
                    {{ user.account }}
                  </a>
                </span>
            ...
            <div class="sellerBtnDiv">
              <div class="btn btn-outline-secondary sellerBtn" @click.prevent="beSeller">賣家中心</div>
