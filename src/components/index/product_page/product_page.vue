<template>
  <div >
        <el-container style="height: auto;">
          <el-aside style="background-color: #EBEBD3; width: 40%; ">
            
            <product_page_photo :ProductPageId="ProductPageId" :photoId="select.main"></product_page_photo>
          </el-aside>
            <el-main style="background-color: #EBEBD3; width: 40%">
            <el-main style="padding: 10px;background-color: #EBEBD3 ;font-size: 30px; font-weight: bold;">{{productPage.name}}</el-main>
            <el-main style="padding: 0 10px 0 10px; background-color:#EBEBD3">
          ...
          <el-container>
           <el-aside style="padding: 10px; background-color:#EBEBD3; width: 20% ;font-size: 20px;">價格</el-aside>
           <el-main style="padding: 10px; background-color: #EBEBD3;font-size: 30px;">
        ...
        <el-container v-if="specificationsMainName!=''">
           <el-aside style="padding: 10px; background-color: #EBEBD3; width: 20%">{{specificationsMainName}}</el-aside>
           <el-main style="padding: 10px; background-color: #EBEBD3">
         ...
         <el-container v-if="specificationsSecondName!=''" >
           <el-aside style="padding: 10px;  background-color: #EBEBD3; width: 20%">{{specificationsSecondName}}</el-aside>
           <el-main style="padding: 10px; background-color: #EBEBD3">
         ...
         <el-container v-else >
             <el-aside style="padding: 10px;  background-color:#fafaec; width: 20%"></el-aside>
           <el-main style="padding: 10px; background-color: #fafaec;height: 75px;">
          </el-main>
        </el-container>
        <el-container>
         <el-aside style="padding: 10px; background-color: #fafaec; width: 20%"><span>數量</span></el-aside>
            <el-main style="padding: 10px; background-color: #fafaec;font-size: 20px; "> 
        ...
        <el-main style="padding: 10px;background-color: #fafaec">
